...
/**
 * Jersey REST client generated for REST resource:we [ws.suscripcion]<br>
 * USAGE:
 * <pre>
 *        SuscripcionWS client = new SuscripcionWS();
...
public class SuscripcionWS {
    ...
    public SuscripcionWS() {
        ...
        webTarget = client.target(BASE_URI).path("ws.suscripcion");
    }
