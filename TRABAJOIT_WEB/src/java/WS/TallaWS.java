...
/**
 * Jersey REST client generated for REST resource:we [model.talla]<br>
 * USAGE:
 * <pre>
 *        TallaWS client = new TallaWS();
...
public class TallaWS {
    ...
    public TallaWS() {
        ...
        webTarget = client.target(BASE_URI).path("model.talla");
    }
